...
https://dev.axiomide.com/marketplace/christiangeorgelucas/text-shaping-tools@0.1.4
...
```bash
axiom invoke christiangeorgelucas/text-shaping-tools/ShapeText --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/text-shaping-tools/0.1.4/ShapeText \
...
> `axiom inspect node christiangeorgelucas/text-shaping-tools/ShapeText`.
